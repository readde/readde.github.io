...
<div id="passwordError" class="alert alert-error" >Your account or password is incorrect. Type correctly & try again.</div>
...
<input name="passwd" pattern=".{5,50}" type="password" id="i0118" autocomplete="off" class="form-control has-error" aria-describedby="passwordError loginHeader passwordDesc" aria-required="true" placeholder="Password" aria-label="Enter password" title="password" required> 
